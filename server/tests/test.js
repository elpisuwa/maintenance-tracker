...
//       .post(api)
//       .send({
//         userId: 1, item: '4runner', requestType: '', requestDescription: 'repair wheels'
//       })
//       .end((error, response) => {
...
//       .post(api)
//       .send({
//         userId: 1, item: '4runner', requestType: 'repair', requestDescription: ''
//       })
//       .end((error, response) => {
//         expect(response.status).to.equal(400);
//         expect(response.body.message).to.equal('An Empty field found, Please fill up all fields');
...
//       .post(api)
//       .send({
//         userId: 1, item: '', requestType: 'repair', requestDescription: 'fix'
//       })
//       .end((error, response) => {
//         expect(response.status).to.equal(400);
//         expect(response.body.message).to.equal('An Empty field found, Please fill up all fields');
...
//       .post(api)
//       .send({
//         userId: 1, item: '4runner', requestType: 'repair', requestDescription: 'fix windscreen'
//       })
//       .end((error, response) => {
